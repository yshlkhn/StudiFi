        ...
        >
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                ...
                <motion.div
                    ...
                    initial="hidden"
                    animate="show"
                    className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 rounded-full border backdrop-blur-2xl border-[rgba(239,169,67,0.25)]
bg-[rgba(239,169,67,0.08)] text-brand-secondary text-sm font-medium"
                >
